...
int main() {
    ...
    // Algoat recognizes std::complex<float> and bypasses standard lexicographical O(N log N)
    // sorting. It routes to the O(N) 16-bit Radix Sort over Morton Z-order curves.
